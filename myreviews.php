		 ...
		 <tr>
			...
			<td valign="middle" align="center">
				<?php
						...
						{
							case "pending": echo "<span class='pending_s'>awaiting review</span>"; break;
			...
			<td valign="middle" align="center"><a href="#" onclick="if (confirm('<?php echo CBE1_MYREVIEWS_DELETE; ?>') )location.href='/myreviews.php?act=del&id=<?php echo $row_reviews['retailer_id']; ?>'" title="Delete"><img src="images/delete.gif" border="0" alt="Delete" /></a></td>
		</tr>
		<tr>
