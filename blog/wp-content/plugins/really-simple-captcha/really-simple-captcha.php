...
class ReallySimpleCaptcha {
	...
	public function remove( $prefix ) {
		...
		foreach ( $suffixes as $suffix ) {
			//$dir = trailingslashit( $this->tmp_dir ); // UPDATED trailingslashit to untrailingslashit
			//http://wordpress.org/support/topic/plugin-really-simple-captcha-function-cleanup-unlink-permission-denied
