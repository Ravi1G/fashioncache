...
define ('CBE_REFERRALS', 'My Referrals');
...
/* NEWS */
define ('CBE1_NEWS_TITLE', 'About Us');
...
define ('CBE1_LOGIN_ERR2', 'Sorry, your account is deactivated.<br/> For more information please <a href="/contact.php">contact us</a>');
define ('CBE1_LOGIN_ERR3', 'You must login first');
define ('CBE1_LOGIN_ERR4', 'You need to login to earn cashback');
define ('CBE1_LOGIN_ERR6', 'You account has been blocked. For more information please <a href="/contact.php">contact us</a>');
...
define ('CBE1_MYPROFILE_CNPASSWORD', 'Confirm New Password');
...
define ('CBE1_ACCOUNT_FAVORITES', 'My Favorite Stores');
define ('CBE1_ACCOUNT_BALACE', 'Balance & History');
...
define ('CBE1_CLICK_TEXT', 'Below you will find the list of 50 latest stores you\'ve visited. So you can track the stores you have looked at.');
...
define ('CBE1_INVITE_FNAME', 'First Name');
define ('CBE1_INVITE_EMAIL', 'Email Address');
define ('CBE1_INVITE_MESSAGE', 'Message');
define ('CBE1_INVITE_BUTTON', 'Send Invitation');
...
define ('CBE1_REVIEW_ERR5', 'You can only submit one review for one store');
...
define ('CBE1_FORGOT_EMAIL', 'Your email address');
