...
\*******************************************************************/
	...
	if (isset($_POST["action"]) && $_POST["action"] == "edit")
	{
		...
		if (count($errors) == 0)
		{
			$sql = "UPDATE cashbackengine_countries SET name='$country_name', signup='$signup', status='$status' WHERE country_id='$country_id'";
...
?>
	...
	?>
		...
		<?php if (isset($errormsg) && $errormsg != "") { ?>
			<div style="width:65%;" class="error_box"><?php echo $errormsg; ?></div>
		<?php } ?>

      <form action="" method="post">
        <table width="70%" bgcolor="#F9F9F9" cellpadding="2" cellspacing="5" border="0" align="center">
		...
		<?php } ?>
          <tr>
            <td width="45%" valign="middle" align="right" class="tb1">Country Code:</td>
          ...
          <tr>
            ...
            <td width="55%" valign="middle"><input type="text" name="country_name" id="country_name" value="<?php echo $row['name']; ?>" size="32" class="textbox" /></td>
			</tr>
            <tr>
				<td valign="middle" align="right" class="tb1">Signup Page</td>
				<td valign="middle"><input type="checkbox" class="checkbox" name="signup" value="1" <?php if ($row['signup'] == 1) echo "checked=\"checked\""; ?> /> <span class="note">show this country on members signup page</span></td>
            </tr>
            <tr>
