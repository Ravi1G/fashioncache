...
?>
     ...
     <h2>Coupon Details</h2>
	  ...
	  <?php if ($total > 0) { $row = mysql_fetch_array($result); ?>
        ...
        <table style="border: 2px dashed #eee;" width="100%" cellpadding="2" cellspacing="5" border="0" align="center">
			...
			<?php } ?>
				...
				<td width="50%" valign="middle" align="right" class="tb1">Title:</td>
				<td width="50%" valign="top"><b><?php echo $row['title']; ?></b></td>
			</tr>
