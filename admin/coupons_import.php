...
if (isset($_POST["action"]) && $_POST["action"] == "import")
{
	...
	if (count($errors) == 0)
	{
		...
		{
			header("Location: coupons_import.php?err=delimiter");
			exit();
		}
		*/
		...
		header("Location: coupons_import.php?msg=done");
		exit();
	}
	else
	{
...
?>
	...
	<?php } elseif (isset($_GET['msg']) && ($_GET['msg']) == "done") { ?>
			<div class="success_box">Coupons have been successfully added</div>
	<?php } ?>
