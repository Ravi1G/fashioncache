...
?>
		...
		<div id="addnew"><a href="affnetwork_edit.php?id=1">Example</a></div>
        ...
        <form action="" method="post">
          ...
          <tr>
            ...
            <td valign="top"><textarea wrap="off" cols="110" rows="1" style="padding-top:5px;" name="csv_format" class="textbox2"><?php echo getPostParameter('csv_format'); ?></textarea></td>
          </tr>
          <tr>
