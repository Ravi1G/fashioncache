...
\*******************************************************************/
	...
	$query = "SELECT * FROM cashbackengine_countries ORDER BY name ASC LIMIT $from, $results_per_page";
	$result = smart_mysql_query($query);

	$total_result = smart_mysql_query("SELECT * FROM cashbackengine_countries ORDER BY name ASC");
...
?>
        ...
        <?php if ($total > 0) { ?>
			...
			<div style="width:440px;" class="success_box">
				<?php
			...
			<table align="center" width="440" border="0" cellpadding="3" cellspacing="0">
			<tr align="center">
				<td colspan="6" align="right"><p align="right">Total countries: <b><?php echo $total ; ?></b></p></td>
			</tr>
			<tr bgcolor="#DCEAFB" align="center">
				...
				<th width="10%">Signup Page <sup><a href="#" title="These countries will be displayed on Signup page.">?</a></sup></th>
			...
			<?php } ?>
				...
				<tr>
					<td colspan="6" valign="top" nowrap="nowrap" align="center">
						<?php
		...
		<br/>
		<div style="width: 450px; background: #F7F7F7; padding: 10px; margin: 0 auto;">
		  <form action="" method="post">
		  <table align="center" width="410" border="0" cellpadding="3" cellspacing="0">
          <tr>
